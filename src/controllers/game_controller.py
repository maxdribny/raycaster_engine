...
class GameController:
    ...
    def check_player_collision_forward(self):
        ...
        is_colliding_x_forward = self.world.map_grid_walls[
                                     player_grid_pos_y * self.world.map_grid_size_x + player_grid_pos_x_add_offset] != 0
        is_colliding_y_forward = self.world.map_grid_walls[
                                     player_grid_pos_y_add_offset * self.world.map_grid_size_x + player_grid_pos_x] != 0

        is_colliding_x_backward = self.world.map_grid_walls[
                                      player_grid_pos_y * self.world.map_grid_size_x + player_grid_pos_x_sub_offset] != 0
        is_colliding_y_backward = self.world.map_grid_walls[
